require 'fox16'
include Fox
require_relative 'client/controller/controller'
require_relative 'client/views/tab_clients'
require_relative 'rest/views/tab_rest'


class Window < FXMainWindow
  def initialize(app)
    super(app, "Clients", width: 900, height: 900) # увеличиваем размер главного окна
    create_tabs
  end
